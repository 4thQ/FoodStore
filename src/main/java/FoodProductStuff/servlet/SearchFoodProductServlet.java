...
@WebServlet("/search-foodproduct")
public class SearchFoodProductServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    try{
      ...
      ArrayList<FoodProduct> foodProducts = foodProductDAO.getFoodProductByDescription(keyword);
