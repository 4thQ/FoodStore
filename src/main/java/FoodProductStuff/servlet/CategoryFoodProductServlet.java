...
@WebServlet("/category-food-product")
public class CategoryFoodProductServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    try{
      ...
      ArrayList<FoodProduct> foodProducts = foodProductDAO.getFoodProductByCategory(req.getParameter("category"));
      req.setAttribute("ListOfFoodProduct", foodProducts);
